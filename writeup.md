...
|| Image			        |     Prediction	        					| 
|:--|:---------------------:|:---------------------------------------------:| 
| ![alt text][image4] | Double curve      	| Double curve   				| 
...
The model was able to correctly guess 4 of the 5 traffic signs, which gives an accuracy of 80%. This compares favorably to the accuracy on the test set of 96.8%. For the last image, I think the unusual pose of the sign is the reason that the model was not able to predict correctly.
